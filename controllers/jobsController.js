...
jobsRouter.post("/add", function(req, res) {
  console.log(req);
  job.create([
    "created_by_id", "modified_by_id", "job_name",  "hours_bid",  "fk_customer_id", "bill_rate", "job_status", "max_labor_cost"
  ], [
    req.body.created_by_id, req.body.modified_by_id, req.body.job_name, req.body.hours_bid,  req.body.fk_customer_id, req.body.bill_rate, req.body.job_status, req.body.max_labor_cost
  ], function(result) {
