<template>
    ...
    <div  class="header">
	    <ul>
           <li v-if="user.roll == 'Admin' || 'Project Coordinator'"><a class="header_a" v-on:click="$parent.updateView('create-project')" >Create Project</a></li>
           <li><a class="header_a" v-on:click="$parent.updateView('open-jobs')" >View open jobs</a></li>
           <li><a class="header_a" v-on:click="$parent.updateView('close-jobs')" >View close jobs</a></li>
           <li><a class="header_a" v-on:click="$parent.updateView('all-jobs')" style="color:#4bc800">View all jobs</a></li>
          </ul>
       </div>   
		   <div class="container">
