...
fk_created_by_id MEDIUMINT,
date_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
fk_modified_by_id MEDIUMINT,
PRIMARY KEY (user_role_id),
	FOREIGN KEY (fk_created_by_id)
	REFERENCES installers_db.users (user_id)
	ON DELETE NO ACTION
	ON UPDATE NO ACTION,
	FOREIGN KEY (fk_modified_by_id)
	REFERENCES installers_db.users (user_id)
	ON DELETE NO ACTION
	ON UPDATE NO ACTION
);
...
PRIMARY KEY (job_id),
	...
	REFERENCES installers_db.customer (customer_id)
	ON DELETE NO ACTION
	ON UPDATE NO ACTION
);
...
INSERT INTO payment_types(fk_created_by_id, fk_modified_by_id, payment_type) VALUES(1, 1, "team_bonus_1"),(1, 1, "team_bonus_2"),(1, 1, "team_bonus_3"),(1, 1, "team_bonus_4"),(1, 1, "Indvidual_bonus_1"),(1, 1, "Indvidual_bonus_2"),(1, 1, "Indvidual_bonus_3"),(1, 1, "Indvidual_bonus_4"),(1, 1, "base_wage");

INSERT INTO jobs(fk_created_by_id, fk_modified_by_id, job_name, start_date, end_date, bill_rate, max_labor_cost) VALUES(1, 1, "Samuel Iuka","2017-10-10","2017-11-04",65,43.5),(1, 1, "Samuel Wisconsin","2017-10-17","2017-11-04",65,43.5);

INSERT INTO bonuses(fk_created_by_id, fk_modified_by_id, production_min, production_max, bonus_weight) VALUES(1, 1, 69.99,0.00,0.75),(1, 1, 79.99,70,0.55),(1, 1, 89.99,80,0.35),(1, 1, 99.99,90,0.25),(1, 1, 109.99,100,0.15);

INSERT INTO installers(fk_created_by_id, fk_modified_by_id, first_name, last_name, current_wage, fk_installer_role_id) VALUES(1, 1, "Sam","Fisher",17.5,105),(1, 1, "Tom","Schulze",17.5,106);

INSERT INTO installer_roles(fk_created_by_id, fk_modified_by_id, installer_role_name, role_weight, min_base, max_base, individual_bonus, team_bonus, bonus_weight) VALUES(1, 1, "Field Operations Manager",1.25,20,27.5,0.25,0.75,1),(1, 1, "Sr. Project Manager",1.2,18.50,22.5,0.3,0.7,1),(1, 1, "Project Manager",1.15,17.5,21.5,0.35,0.65,1),(1, 1, "Jr. Project Manager",1.1,16.5,20,0.4,0.6,0.95),(1, 1, "Sr. Project Lead",1.05,15,19,0.45,0.55,0.85),(1, 1, "Project Lead",1,15,17.5,0.5,0.5,0.85),(1, 1, "Jr. Project Lead",0.95,13.5,16,0.55,0.45,0.75),(1, 1, "Sr. Technician",0.9,12,15,0.60,0.40,0.75),(1, 1, "Technician",0.85,11,12.5,0.65,0.35,0.65),(1, 1, "Jr. Technician",0.8,10,11,0.7,0.3,0.55),(1, 1, "Laborer",0.75,8.15,11,0.75,0.25,0.5);

INSERT INTO jobs_installers(fk_created_by_id, fk_modified_by_id, fk_job_id, fk_installer_id, fk_installer_role_id, hours_bid) VALUES(1, 1, 50001,10001,105,100),(1, 1, 50001,10002,106,100),(1, 1, 50002,10001,105,50),(1, 1, 50002,10002,106,50);

INSERT INTO user_roles(fk_created_by_id, fk_modified_by_id, user_role_name) VALUES(1, 1, "Admin"),(1, 1, "Installer"),(1, 1, "Project Coordinator"),(1, 1, "Project Manager");
